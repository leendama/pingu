...
export const DEFAULT_WORKFLOWS: WorkflowDefinition[] = [
  {
    ...
    allowedTools: ["search_calendar", "read_calendar_event", "search_gmail", "read_gmail_message", "search_personal_brain", "read_personal_note", "list_commitments"],
  },
  {
    ...
    allowedTools: ["search_personal_brain", "read_personal_note", "list_granola_notes", "get_granola_note", "list_commitments"],
  },
  {
    ...
    allowedTools: ["search_personal_brain", "read_personal_note", "list_commitments", "search_calendar"],
  },
];
