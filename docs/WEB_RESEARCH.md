...
Before treating research quality as validated, run live cases for: a dated primary-source announcement; conflicting public claims; a stale article requested as current; a blocked or missing URL; and an instruction-injection page. Check claim-to-source support, temporal accuracy, honesty about access, useful brevity, and absence of actions. No live model-quality evaluation has been completed in this change.
